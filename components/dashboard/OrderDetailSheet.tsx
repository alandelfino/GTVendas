                ...
                {loading ? (
                    ...
                    <ScrollView contentContainerStyle={styles.modalScroll} showsVerticalScrollIndicator={false}>
                                ...
                                return (
                                    <View key={idx}>
                                        <View style={styles.iosItemRowExpanded}>
                                            <View style={{ flex: 1 }}>
                                                <Text style={[styles.iosItemRef, { color: theme.accent, marginBottom: 4 }]}>
                                                    {prodRef}
                                                </Text>
                                                <Text style={[styles.iosItemName, { color: theme.secondary, fontSize: 14, textTransform: 'capitalize', fontWeight: '400' }]}>
                        ...
                        <View style={[styles.iosGroupedCard, { backgroundColor: theme.card, marginBottom: 40 }]}>
                            ...
                            {(() => {
                                const totalUnits = (order.itens || []).reduce((acc, it: any) => {
                                    const variations = Array.isArray(it.variacoes) ? it.variacoes : [];
                                    const qty = it.quantidade || (variations.reduce((a: number, v: any) => a + (v.amount || 0), 0)) || 0;
                                    return acc + qty;
                                }, 0);
                                ...
                                return (
                                    <>
                                        <View style={styles.iosRow}>
                                            <Text style={[styles.iosLabel, { color: theme.secondary }]}>Total de Unidades</Text>
                                            <Text style={[styles.iosValue, { color: theme.text, fontWeight: '600' }]}>{totalUnits} un</Text>
                                        </View>
                                        <View style={[styles.iosSeparator, { backgroundColor: theme.separator }]} />
                                    </>
                                );
